      ...
      return [r].flat().reduce((s4, a2) => {
        if (a2 != null) {
          ...
          if (u === "string" || u === "number") s4.push(a2);
            ...
            let c = Array.isArray(a2) ? o(n, a2) : Object.entries(a2).map(([f2, g4]) => n === "style" && (g4 || g4 === 0) ? `${f2.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}:${g4}` : g4 ? f2 : void 0);
  ...
  if (p(e)) {
    ...
    if (z(a2, k)) {
      let n = a2.replaceAll(k, (l2) => {
        let c = l2.replace(/{|}/g, "").split(".").filter((m2) => !s4.some((d2) => z(m2, d2)));
...
function le(e, t2) {
  ...
  function r(n, l2) {
    ...
    for (; c <= n.length; ) {
      let h = n[c];
      if ((h === '"' || h === "'" || h === "`") && n[c - 1] !== "\\" && (d2 = d2 === h ? null : h), !d2 && (h === "(" && u++, h === ")" && u--, (h === "," || c === n.length) && u === 0)) {
        let f2 = m2.trim();
        f2.startsWith("dt(") ? o.push(le(f2, l2)) : o.push(s4(f2)), m2 = "", c++;
        continue;
      }
      h !== void 0 && (m2 += h), c++;
    }
...
var ue2 = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: i2, options: a2 } = S.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, o = z(t2, k) ? t2 : `{${t2}}`;
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let h = m2[u], f2 = ve(h), p3 = z(u, a2) ? Q2(d2) : Q2(d2, ee(u));
...
var b2 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  let a2 = function(l2, o = {}, c = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      let u = z(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe2(m2)}` : oe2(m2), h = c ? `${c}.${m2}` : m2;
...
//# sourceMappingURL=chunk-3SZCTBPB.js.map
